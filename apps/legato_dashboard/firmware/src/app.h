...
#define INFOPAGE_CANVAS_ID 1
#define LEFT_NEEDLE_CANVAS_ID 2
#define RIGHT_NEEDLE_CANVAS_ID 3
#define MCHP_LOGO_CANVAS_ID 4
#define MHGC_LOGO_CANVAS_ID 5
#define BACKGROUND_LAYER_ID 0
#define INFOPAGE_LAYER_ID 1
#define LEFT_NEEDLE_LAYER_ID 1
#define RIGHT_NEEDLE_LAYER_ID 2
#define MCHP_LOGO_LAYER_ID 1
#define MHGC_LOGO_LAYER_ID 2

#define SCENE1_MAX_NEEDLE_VALUE 180
#define SCENE2_MAX_NEEDLE_VALUE 226

#define NEEDLE_FADE_IN_START_ALPHA 50
#define NEEDLE_FADE_IN_END_ALPHA 180
#define NEEDLE_FADE_OUT_START_ALPHA NEEDLE_FADE_IN_END_ALPHA
#define NEEDLE_FADE_OUT_END_ALPHA 0
