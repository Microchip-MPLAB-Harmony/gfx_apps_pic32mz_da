...
leResult screenShow_Screen0(void)
{
    ...
    Screen0_ImageWidget0->fn->setPosition(Screen0_ImageWidget0, 6, 6);
    ...
    Screen0_ImageWidget1->fn->setPosition(Screen0_ImageWidget1, 44, 64);
    ...
    Screen0_ButtonWidget0->fn->setPosition(Screen0_ButtonWidget0, 263, 132);
    ...
    Screen0_LabelWidget0->fn->setPosition(Screen0_LabelWidget0, 235, 87);
    ...
    Screen0_LabelWidget1->fn->setSize(Screen0_LabelWidget1, 65, 40);
    ...
    Screen0_LabelWidget2->fn->setPosition(Screen0_LabelWidget2, 365, 87);
