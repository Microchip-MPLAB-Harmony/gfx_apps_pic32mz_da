...
leResult screenShow_Screen0(void)
{
    ...
    // layer 0
    root0 = leWidget_New();
    root0->fn->setSize(root0, 272, 480);
    ...
    Screen0_BackgroundPanel->fn->setSize(Screen0_BackgroundPanel, 272, 480);
    ...
    Screen0_mhgsLogo->fn->setPosition(Screen0_mhgsLogo, 45, 60);
    ...
    Screen0_fastLabel->fn->setPosition(Screen0_fastLabel, 14, 270);
    ...
    Screen0_easyLabel->fn->setPosition(Screen0_easyLabel, 90, 270);
    ...
    Screen0_smartLabel->fn->setPosition(Screen0_smartLabel, 170, 270);
    ...
    Screen0_qsButton->fn->setPosition(Screen0_qsButton, 55, 350);
    Screen0_qsButton->fn->setSize(Screen0_qsButton, 160, 80);
