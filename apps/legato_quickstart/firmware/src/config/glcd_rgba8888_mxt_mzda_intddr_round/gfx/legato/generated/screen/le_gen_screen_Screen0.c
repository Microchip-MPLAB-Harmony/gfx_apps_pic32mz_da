...
leResult screenShow_Screen0(void)
{
    ...
    Screen0_BackgroundPanel->fn->setSize(Screen0_BackgroundPanel, 432, 432);
    ...
    Screen0_mchpLogo->fn->setPosition(Screen0_mchpLogo, 156, 37);
    ...
    Screen0_mhgsLogo->fn->setPosition(Screen0_mhgsLogo, 126, 87);
    ...
    Screen0_fastLabel->fn->setPosition(Screen0_fastLabel, 100, 270);
    ...
    Screen0_easyLabel->fn->setPosition(Screen0_easyLabel, 175, 270);
    ...
    Screen0_smartLabel->fn->setPosition(Screen0_smartLabel, 250, 270);
    ...
    Screen0_qsButton->fn->setPosition(Screen0_qsButton, 136, 338);
